...
files=$(ls ${PBS_O_WORKDIR}//${filespos}/m*.cnf | shuf --random-source=${PBS_O_WORKDIR}//myrnd)
...
do
    ...
    do
        ...
        then
            ...
            todo="./gringo -o smodels clingo_${filename} | /usr/bin/time --verbose -o minimize_${filename}.timeout ./wasp --minimize-predicate=d -n0 --minimization-algorithm=guess-check-minimize --silent=2 >> result-${filename}.out 2>&1"
            echo "$todo" >> todo

            todo="./gringo -o smodels clingo_${filename} | /usr/bin/time --verbose -o core_${filename}.timeout ./wasp --minimize-predicate=d -n0 --minimization-algorithm=core-based --silent=2 >> result-${filename}.out 2>&1"
            echo "$todo" >> todo
            ...
            todo="./gringo -o smodels mus_${filename} | /usr/bin/time --verbose -o minimize_prep_${filename}.timeout ./wasp --minimize-predicate=d -n0 --minimization-algorithm=guess-check-minimize --silent=2 >> result-${filename}.out 2>&1"
            echo "$todo" >> todo

            todo="./gringo -o smodels mus_${filename} | /usr/bin/time --verbose -o core_prep_${filename}.timeout ./wasp --minimize-predicate=d -n0 --minimization-algorithm=core-based --silent=2 >> result-${filename}.out 2>&1"
            echo "$todo" >> todo
